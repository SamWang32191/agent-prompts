...
本 Skill 協助使用者根據 Git 的 staged changes 自動產生符合標準規範的 Commit Message。它能分析程式碼變更的內容與語意，並依照 [Conventional Commits](.shared/references/conventions.md) 格式產出清晰、描述性強的訊息。
...
1.  **判斷 Type**：是新增功能 (`feat`)、修復 (`fix`)、文件 (`docs`) 還是其他？請參考 [references/conventions.md](.shared/references/conventions.md) 中的定義。
...
*   **Commit 規範**：詳細的 Type 定義與格式範例，請見 [references/conventions.md](.shared/references/conventions.md)。